...
public class Result<T>
{
    ...
    private Result(NagadProblem problem)
    {
        Problem = problem;
        IsSucceeded = false;
    }
    ...
    /// </summary>
    public NagadProblem? Problem { get; private set; }
    ...
    /// </summary>
    /// <param name="problem">NagadProblem occurred during the operation.</param>
    /// <returns>A object of type <see cref="Result{T}"/>.</returns>
    public static Result<T> Create(NagadProblem problem)
    {
...
public class Result
{
    ...
    /// <returns>A object of type <see cref="Result"/>.</returns>
    public static Result Create(NagadProblem problem)
    {
